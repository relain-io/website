...
const translations = {
  en: {
    ...
    'contact.location.address': 'Südliche Münchnerstrasse 60c\nGrünwald 82031\nGermany',
    ...
    'impressum.company.address': 'Südliche Münchnerstrasse 60c\nGrünwald 82031\nGermany',
    'impressum.contact': 'Contact Information',
    'impressum.contact.email': 'info@relain.io',
    'impressum.contact.phone': '+49 89 123 456 789',
    'impressum.legal': 'Legal Details',
    'impressum.legal.register': 'Commercial Register: Munich HRB XXXXX',
    'impressum.legal.vat': 'VAT ID: DE XXXXXXXXX',
  ...
  de: {
    ...
    'impressum.legal.register': 'Handelsregister: München HRB XXXXX',
    'impressum.legal.vat': 'USt-IdNr.: DE XXXXXXXXX',
